...
| `TAVILY_API_KEY` | All types | [tavily.com](https://tavily.com/) |
| `TWITTER_API_KEY` | Type 4 & 7 | [twitterapi.io](https://twitterapi.io/) |
| `RAPIDAPI_KEY` | Type 8 (Earnings) | [rapidapi.com](https://rapidapi.com/) |
